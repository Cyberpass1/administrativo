 ...
 * @author FCGinebraI
 */
public class JDiagnostico extends javax.swing.JInternalFrame {
...
listarEspecialidades();
    ...
    private void initComponents() {
        ...
        FechaAc2.setText("R E G I S T R O      D I A G N O S T I C O S");
        ...
        TxtEspecialidad.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Diagnostico"));
        ...
        TXTfindbyName.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Diagnostico"));
 ...
 int row = JTableEspecialidad.getRowCount();
    ...
    private void ActivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ActivarActionPerformed
        ...
        if (fila == -1) {
            ...
            else if (setState.inactivarAntecedenteF(100,      idespecialidades )) {
    ...
    private void DesactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DesactivarActionPerformed
        ...
        if (fila == -1) {
            ...
            else if (setState.inactivarAntecedenteF(101,       idespecialidades )) {
...
eliminarPaciente();
   ...
   public void AgregarEspecialidad(){                                             
    ...
    ResultSet rs;
          ...
          try {
            ...
            String sql = "INSERT INTO table_resultado(diagnostico) VALUES (?)";
            con = cn.getConnection();
            ps = con.prepareStatement(sql);
  ...
  JOptionPane.showMessageDialog(null, "DIAGNOSTICO REGISTRADO","REGISTRO", 1);
        } catch (Exception e) {
    ...
    ResultSet rs;
        ...
        try {
            ...
            String sql = "update table_resultado set  diagnostico=? where id_resultado =?";
            ...
            if (res >= 1) {
                    JOptionPane.showMessageDialog(null, "DIAGNOSTICO ACTUALIZADO", "ACTUALIZACIÓN DE DATOS", 1);
            
                
            } else {
                JOptionPane.showMessageDialog(null, "ERROR AL ACTUALIZAR EL DIAGNOSTICO", "ERROR", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception e) {
            System.out.println(e);
            JOptionPane.showMessageDialog(null, "ERROR AL ACTUALIZAR EL DIAGNOSTICO", "ANTECEDENTES", JOptionPane.ERROR_MESSAGE);
           }
   ...
   public void eliminarPaciente() {
    ...
    try {
      ...
      String mensaje = "¿Está seguro de que desea eliminar " + antecedente + " de la tabla diagnosticos?";
      mensaje += "\nNOTA: SI ELIMINA UN DIAGNOSTICO QUE SE HA VENIDO UTILIZANDO DESAPARECERA DE LA ESTADISTICA EPIDEMIOLOGICA";
   ...
   int confirmacion = JOptionPane.showConfirmDialog(
    ...
    JOptionPane.YES_NO_OPTION
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            String sql = "DELETE FROM `table_resultado` WHERE id_resultado   = ?";
            ...
            if (res >= 1) {
                JOptionPane.showMessageDialog(null, "El diagnostico ha sido eliminado", "Actualización de Datos", JOptionPane.INFORMATION_MESSAGE);
                limpiarTabla();
                limpiarTabla();
                listarEspecialidades();
                AuditoriaBorrar();
            } else {
                JOptionPane.showMessageDialog(null, "Error al eliminar el diagnostico", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    } catch (Exception e) {
        System.out.println(e);
   ...
   try {
            ...
            String accion= "Elimino el diagnostico: " +antecedente +" " ;
            con = cn.getConnection();
            ps = con.prepareStatement(sql);
  ...
  BtnAgg.setEnabled(true);
     ...
     public void listarEspecialidades() {
        ...
        List<JCEspecialidades> lista = EspecialidadDao.listarDiagnostico();
        modelo = (DefaultTableModel) JTableEspecialidad.getModel();
        Object[] ob = new Object[5];

        for (int i = 0; i < lista.size(); i++) {

            ob[0] = lista.get(i).getIdDianostico();
            ob[1] = lista.get(i).getDiagnostico();
            ob[2] = lista.get(i).getEstadoDiagnostico();
    ...
    public void acomodarceldas()
    {
        ...
        JTableEspecialidad.getColumnModel().getColumn(Tabla.findColumn("DIAGNOSTICOS")).setPreferredWidth(300);
        ...
        JTableEspecialidad.getColumnModel().getColumn(Tabla.findColumn("DIAGNOSTICOS")).setCellRenderer(Alinear);
 ...
 String busqueda = this.TXTfindbyName.getText();
 String sql = "SELECT u.Id_AFamiliares, u.Enfermedad, x.Estado " +
             "FROM table_afamiliares u " +
             "INNER JOIN table_estado x ON u.Estado = x.IdEstado " +
             "WHERE u.Enfermedad LIKE '%" + busqueda + "%'";

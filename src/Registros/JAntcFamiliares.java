 ...
 * @author FCGinebraI
 */
public class JAntcFamiliares extends javax.swing.JInternalFrame {

    /**
     * Creates new form JUREGISTRO
     */
    public JAntcFamiliares() {
           initComponents();
...
listarEspecialidades();
    ...
    private void initComponents() {
        ...
        FechaAc2.setText("R E G I S T R O      ANTC. FAMILIARES");
        ...
        TxtEspecialidad.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Antecedente Familiar"));
        ...
        TXTfindbyName.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Antc. Familiar"));
...
eliminarPaciente();
   ...
   public void AgregarEspecialidad(){                                             
    ...
    ResultSet rs;
          ...
          try {
            ...
            String sql = "INSERT INTO table_afamiliares (Enfermedad) VALUES (?)";
            con = cn.getConnection();
            ps = con.prepareStatement(sql);
  ...
  JOptionPane.showMessageDialog(null, "ANTECEDENTE REGISTRADO","REGISTRO", 1);
    ...
    ResultSet rs;
        ...
        try {
            ...
            String sql = "update table_afamiliares set  Enfermedad=? where Id_AFamiliares=?";
   ...
   int confirmacion = JOptionPane.showConfirmDialog(
    ...
    JOptionPane.YES_NO_OPTION
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            String sql = "DELETE FROM `table_afamiliares` WHERE Id_AFamiliares  = ?";
   ...
   try {
            ...
            String accion= "Elimino el antecedente familiar: " +antecedente +" " ;
            con = cn.getConnection();
            ps = con.prepareStatement(sql);
  ...
  BtnAgg.setEnabled(true);
     ...
     public void listarEspecialidades() {
        ...
        List<JCEspecialidades> lista = EspecialidadDao.listarAntcFam();
        modelo = (DefaultTableModel) JTableEspecialidad.getModel();
        Object[] ob = new Object[5];

        for (int i = 0; i < lista.size(); i++) {

            ob[0] = lista.get(i).getIdAntcF();
            ob[1] = lista.get(i).getAntcF();
            ob[2] = lista.get(i).getEstadoantcF();
    ...
    public void acomodarceldas()
    {
        ...
        JTableEspecialidad.getColumnModel().getColumn(Tabla.findColumn("ANTC. FAMILIAR")).setPreferredWidth(300);
        ...
        JTableEspecialidad.getColumnModel().getColumn(Tabla.findColumn("ANTC. FAMILIAR")).setCellRenderer(Alinear);

...
public class JServicios extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "CODIGO", "SERVICIO", "PRECIO", "CATEGORIA", "ESTADO"
            }
        ) {
        ...
        FechaAc2.setText("M Ó D U L O      S E R V I C I O S");
        jPanel2.add(FechaAc2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 10, 260, -1));

        jTxtServicios.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Servicio"));
        jPanel2.add(jTxtServicios, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 150, 350, 50));
        ...
        jPanel2.add(jTxtPrecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 200, 170, 50));
        ...
        jPanel2.add(jTxtPrecio1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 200, 170, 50));
        ...
        jPanel2.add(jCategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 90, 350, 50));
        ...
        jTextField2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Buscar servicio"));
    ...
    private void BtnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAgregarActionPerformed
        ...
        if(jTxtServicios.getText().equals("")|| jTxtPrecio.getText().equals("")){
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (fila == -1) {
            ...
            jCategoria.setSelectedItem(jTable1.getValueAt(fila, 1).toString());
            jTxtServicios.setText(jTable1.getValueAt(fila, 2).toString());
            jTxtPrecio.setText(jTable1.getValueAt(fila, 3).toString());
            
            servName=(jTable1.getValueAt(fila, 2).toString());
            
            
            servEstado=(jTable1.getValueAt(fila, 5).toString());
            calcularMonto();
    }                                  
    ...
    private void ActivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ActivarActionPerformed
           if (JOptionPane.showConfirmDialog(rootPane, "¿Desea realmente Activar este servicio?",
            "ACTIVAR SERVICIO", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION)  {
        ...
        if (fila == -1) {
            ...
            if (servEstado.equals("Activo")){ JOptionPane.showMessageDialog(null, "EL SERVICIO YA SE ENCUENTA: Activo", "Estado", JOptionPane.WARNING_MESSAGE);}
            else if (setState.inactivarServicio(100, idServc )) {

                JOptionPane.showMessageDialog(null, "EL ESTADO DEL SERVICIO SE HA ACTUALIZADO HA : Activo", "Estado", 1);
                limpiarTabla();
                listarServicios();
             
                audtiActivarServ("Activo el servicio");
    ...
    private void InactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InactivarActionPerformed
          if (JOptionPane.showConfirmDialog(rootPane, "¿Desea realmente inactivar este servicio?",
            "INACTIVAR SERVICIO", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION)  {
        ...
        if (fila == -1) {
            ...
            if (servEstado.equals("Inactivo")){ JOptionPane.showMessageDialog(null, "EL SERVICIO YA SE ENCUENTA: Inactivo", "Estado", JOptionPane.WARNING_MESSAGE);}
            else if (setState.inactivarServicio(101, idServc)) {

                JOptionPane.showMessageDialog(null, "EL ESTADO DEL SERVICIO SE HA ACTUALIZADO HA : Inactivo", "Estado", 1);
                limpiarTabla();
                listarServicios();
                audtiActivarServ("Inactivo el servicio");
              //  audtDesactCatg();
...
public void knowCode() {
    ...
    try {
      ...
      public  void listarServicios() {
        ...
        List<JCFactura> lista = factDao.listarServices();
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            ob[4] = lista.get(i).getServ_catg();
            ob[5] = lista.get(i).getServ_estado();
   ...
   public void agregarServicio(){                                             
    ...
    ResultSet rs=null;
          ...
          try {
            ...
            String sql = "INSERT INTO `table_servicios`(`serv_codigo`, `servicio`, `serv_precio`, `serv_categoria`) VALUES (?,?,?,(SELECT Id_CatgServ FROM categorias_servicios WHERE Catg_Servicio=?))";
            con = cn.getConnection();
            ps = con.prepareStatement(sql);
      
            ps.setString(1, codeServ);
            ps.setString(2, jTxtServicios.getText());
         ...
         JOptionPane.showMessageDialog(null, "SE HA REGISTRADO EL SERVICIO","REGISTRO", 1);
        } catch (Exception e) {
...
String sql = "SELECT id_servicio, serv_codigo, servicio, serv_precio, Catg_Servicio, e.estado, serv_estado " +
               "FROM table_servicios u " +
               "INNER JOIN table_estado e ON u.serv_estado = e.IdEstado " +
               "INNER JOIN categorias_servicios c ON u.serv_categoria = c.Id_CatgServ " +
               "WHERE servicio LIKE ?";
        ...
        try
        {
            ...
            {
                //LLENADO DE TABLA
               int col1 = rs.getInt("id_servicio");
               String col2 = rs.getString("serv_codigo");
               String col3 = rs.getString("servicio");
               String col4 = rs.getString("serv_precio");
               String col5 = rs.getString("Catg_Servicio");
               String col6 = rs.getString("e.estado");
    ...
    String sql = "UPDATE `table_servicios` SET `servicio`=?, `serv_precio`=?, `serv_categoria`=(SELECT Id_CatgServ FROM categorias_servicios WHERE Catg_Servicio=?) WHERE `id_servicio`=?";

    try (Connection con = new EnlaceBd().getConnection();
         PreparedStatement ps = con.prepareStatement(sql)) {

        ps.setString(1, jTxtServicios.getText());
        ...
        if (res >= 1) {
            JOptionPane.showMessageDialog(null, "SERVICIO ACTUALIZADO", "ACTUALIZACIÓN DE DATOS", JOptionPane.INFORMATION_MESSAGE);
        } else {
     ...
     public void acomodarceldas()
    {
        ...
        jTable1.getColumnModel().getColumn(Tabla.findColumn("CODIGO")).setPreferredWidth(80);
        jTable1.getColumnModel().getColumn(Tabla.findColumn("SERVICIO")).setPreferredWidth(120);
        jTable1.getColumnModel().getColumn(Tabla.findColumn("PRECIO")).setPreferredWidth(30);
        jTable1.getColumnModel().getColumn(Tabla.findColumn("CATEGORIA")).setPreferredWidth(60);
        ...
        jTable1.getColumnModel().getColumn(Tabla.findColumn("SERVICIO")).setCellRenderer(Alinear);
   ...
   try {
            ...
            String accion= Accion+" "+jTxtServicios.getText() ;
            con = cn.getConnection();
            ps = con.prepareStatement(sql);
    ...
    try {
      ...
      String mensaje = "¿Está seguro de que desea eliminar " + servName + " de la tabla de servicios?";
      mensaje += "\nNOTA: Si existen facturas con este servicio asignado y lo elimina, no podran visualizar los mismos";
   ...
   int confirmacion = JOptionPane.showConfirmDialog(
    ...
    JOptionPane.YES_NO_OPTION
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            String sql = "DELETE FROM `table_servicios` WHERE id_servicio = ?";
            ...
            if (res >= 1) {
                JOptionPane.showMessageDialog(null, "El servicio ha sido eliminado", "Actualización de Datos", JOptionPane.INFORMATION_MESSAGE);
                limpiarTabla();
                listarServicios();
                audtiActivarServ("Elimino el siguiente servicio de la tabla: ");
            } else {
                JOptionPane.showMessageDialog(null, "Error al eliminar el servicio", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    } catch (Exception e) {
        System.out.println(e);

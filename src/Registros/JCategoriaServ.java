 ...
 * @author FCGinebraI
 */
public class JCategoriaServ extends javax.swing.JInternalFrame {

    /**
     * Creates new form JUREGISTRO
     */
    public JCategoriaServ() {
           initComponents();
...
listarEspecialidades();
    ...
    private void initComponents() {
        ...
        FechaAc2.setText("C A T E G O R I A      S E R V I C I O S");
        ...
        TxtEspecialidad.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Servicio"));
        ...
        TXTfindbyName.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Servicio"));
 ...
 int row = JTableEspecialidad.getRowCount();
   ...
   public void AgregarEspecialidad(){                                             
    ...
    ResultSet rs;
          ...
          try {
            ...
            String sql = "INSERT INTO categorias_servicios (Catg_Servicio) VALUES (?)";
  ...
  JOptionPane.showMessageDialog(null, "CATEGORIA REGISTRADA","REGISTRO", 1);
    ...
    ResultSet rs;
        ...
        try {
            ...
            String sql = "UPDATE `categorias_servicios` SET `Catg_Servicio`=? WHERE `Id_CatgServ`=?";
  ...
  BtnAgg.setEnabled(true);
     ...
     public void listarEspecialidades() {
        ...
        List<JCFactura> lista = facDao.listarCatgServ();
    ...
    public void acomodarceldas()
    {
        ...
        JTableEspecialidad.getColumnModel().getColumn(Tabla.findColumn("SERVICIO")).setPreferredWidth(60);
        ...
        JTableEspecialidad.getColumnModel().getColumn(Tabla.findColumn("SERVICIO")).setCellRenderer(Alinear);
   ...
   try {
            ...
            String accion= "Agrego el la categoria servicio: " +TxtEspecialidad.getText() +" " ;
            con = cn.getConnection();
            ps = con.prepareStatement(sql);
   ...
   try {
            ...
            String sql = "INSERT INTO table_auditoria (IdUsuario, IdPersonal, Accion,FechaMov) values (?,?,?,?)";
            String accion= "Modifico la categoria servicio: " +TxtEspecialidad.getText() +" " ;
            con = cn.getConnection();
            ps = con.prepareStatement(sql);
            ps.setInt(1, idusuario);
            ps.setInt(2, idusuario);
 ...
 String sql = "select Id_CatgServ, Catg_Servicio, Catg_estado  from categorias_servicios u\n" +
"INNER JOIN table_estado x\n" +
"ON u.Id_CatgServ= x.IdEstado where  Catg_Servicio LIKE '%" + Busqueda + "%' ";
